...
Начиная с прошивки [FP3.6.A.040.2] на Fairphone 3, прошивки [FP4.QREL.15.17.2] на Fairphone 4, прошивки [FP5.VT2X.C.107] на Fairphone 5 и прошивки [FP6.QREL.16.69.0] на Fairphone (Gen. 6/Gen. 6+), Fairphone перешёл на [стандартную процедуру разблокировки](../../../misc/generic-unlock.md). Опция OEM unlock по-прежнему требует подключения к интернету для проверки запроса.
